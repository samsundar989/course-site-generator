...
public class AppNodesBuilder {
    ...
    public TabPane buildTabPane(Object nodeId,Pane parentPane,String styleClass, boolean enabled){
        TabPane tabPane = new TabPane();
        initNode(nodeId, tabPane, parentPane, styleClass, enabled);
        return tabPane;
    }
    public Tab buildTab(Object nodeId,TabPane parentPane,String styleClass, boolean enabled, String name){
        Tab tab = new Tab();
        tab.setId(nodeId.toString());
        tab.setText(name);
    ...
    public VBox buildTabVBox(Object nodeId,Tab parentTab,String styleClass, boolean enabled){
        VBox vbox = new VBox();
        vbox.setId(nodeId.toString());
        vbox.getStyleClass().add(styleClass);
        vbox.setDisable(!enabled);
        parentTab.setContent(vbox);
        return vbox;
    }
    public ScrollPane buildTabScrollPane(Object nodeId,Tab parentTab,String styleClass, boolean enabled){
        ScrollPane scrollPane = new ScrollPane();
        scrollPane.setId(nodeId.toString());
        scrollPane.getStyleClass().add(styleClass);
        scrollPane.setDisable(!enabled);
        parentTab.setContent(scrollPane);
        return scrollPane;
    }

    public VBox buildScrollVBox(Object nodeId,ScrollPane pane,String styleClass, boolean enabled){
        VBox vbox = new VBox();
        vbox.setId(nodeId.toString());
        vbox.getStyleClass().add(styleClass);
        vbox.setDisable(!enabled);
