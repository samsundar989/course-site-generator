...
import cg.CGApp;
import static cg.CGPropertyType.CG_ALL_RADIO_BUTTON;
import static cg.CGPropertyType.CG_END_TIME_COMBOBOX;
import static cg.CGPropertyType.CG_GRAD_RADIO_BUTTON;
...
/**
 * This is the data component for TAManagerApp. It has all the data needed to be set by the user via the User Interface and file I/O can set and get all the data from this object
 *
 * @author Samuel Sundararaman
 */
public class CGData implements AppDataComponent {
    ...
    public TAType getSelectedType() {
        RadioButton allRadio = (RadioButton) app.getGUIModule().getGUINode(CG_ALL_RADIO_BUTTON);
        if (allRadio.isSelected()) {
            return TAType.All;
        }
        RadioButton gradRadio = (RadioButton) app.getGUIModule().getGUINode(CG_GRAD_RADIO_BUTTON);
    ...
    public TeachingAssistantPrototype getSelectedTA() {
        AppGUIModule gui = app.getGUIModule();
        TableView<TeachingAssistantPrototype> tasTable = (TableView) gui.getGUINode(CG_TAS_TABLE_VIEW);
    ...
    public boolean isTASelected() {
        AppGUIModule gui = app.getGUIModule();
        TableView tasTable = (TableView) gui.getGUINode(CG_TAS_TABLE_VIEW);
    ...
    public boolean isTATypeSelected() {
        AppGUIModule gui = app.getGUIModule();
        RadioButton allRadioButton = (RadioButton) gui.getGUINode(CG_ALL_RADIO_BUTTON);
    ...
    public void changeHours(String startHourText, String endHourText) {
        int initStartHour = Integer.parseInt(startHourText);
        int initEndHour = Integer.parseInt(endHourText);
        if (initStartHour <= initEndHour) {
            // THESE ARE VALID HOURS SO KEEP THEM
