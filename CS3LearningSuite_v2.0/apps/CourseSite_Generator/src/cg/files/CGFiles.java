 ...
 */
public class CGFiles implements AppFileComponent {
	...
	CGData dataManager = (CGData)data;
        dataManager.reset();
    ...
    private void loadTAs(CGData data, JsonObject json, String tas) {
